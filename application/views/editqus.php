					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Edit-Question</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
  ...
  <div class="row">
		...
		<?php   $cnt=1;
		 ...
		 $id = $row['id'];
            ...
            ?>		
	<form action="<?php echo site_url('admin/updatequestion'); ?>/<?php echo $id;?>" method="post"  enctype="multipart/form-data">
	...
	<textarea id="editor1" name="Question" class="ckeditor" ><?php echo $row['question']?></textarea> </td>                  
		    ...
		    <div class="form-group">
                <div class="col-md-6">
                  ...
                  <div class="form-label-group">
				  <textarea id="editor1" name="option1" class="ckeditor" ><?php echo $row['opt1']?></textarea>                   
		    ...
		    <div class="form-group">
                <div class="col-md-6">
                  ...
                  <div class="form-label-group">
				  <textarea id="editor1" name="option2" class="ckeditor" ><?php echo $row['opt2']?></textarea>                   
		    ...
		    <div class="form-group">
                <div class="col-md-6">
                  ...
                  <div class="form-label-group">
				  <textarea id="editor1" name="option3" class="ckeditor" ><?php echo $row['opt3']?></textarea>                   
		    ...
		    <div class="form-group">
                <div class="col-md-6">
                  ...
                  <div class="form-label-group">
				  <textarea id="editor1" name="option4" class="ckeditor" ><?php echo $row['opt4']?></textarea>                   
            ...
            <div class="form-group">
              ...
              <div class="form-label-group">
		<textarea id="editor1" name="Correct" class="ckeditor" ><?php echo $row['correct_opt']?></textarea>                   
				...
				<div class="col-md-6" style="padding:1em">
						<input class="btn btn-success  mr-10" type="submit" value="Update Question" name="save">
